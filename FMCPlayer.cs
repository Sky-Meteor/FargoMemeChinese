...
{
    public class FMCPlayer : ModPlayer
    {
        public override void OnEnterWorld(Player player)
        {
            ...
            {
                ChatHelper.BroadcastChatMessage(NetworkText.FromLiteral("注意！你现在使用的是Fargo梗体汉化补丁，如果你是第一次游玩Fargo，推荐使用Fargo突变&魂汉化补丁以获得最好的游戏体验！"), Color.LightGreen);
